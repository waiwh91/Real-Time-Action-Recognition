...
import sys
from sklearn.neighbors import _classification
from sklearn.svm import _classes
from sklearn.gaussian_process import _gpc
...
sys.modules['sklearn.neighbors.classification'] = _classification
sys.modules['sklearn.svm.classes'] = _classes
sys.modules['sklearn.gaussian_process.gpc'] = _gpc
sys.modules['sklearn.tree.tree'] = tree
sys.modules['sklearn.ensemble.forest'] = _forest
sys.modules['sklearn.neural_network.multilayer_perceptron'] = _multilayer_perceptron
sys.modules['sklearn.preprocessing.label'] = _label
sys.modules['sklearn.ensemble.weight_boosting'] = _weight_boosting
